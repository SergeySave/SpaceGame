...
public class InConstructionRenderSystem extends EntitySystem {
    ...
    private static final float MULT = Color.toFloatBits(1f, 1f, 1f, 0.5f);
    ...
    public InConstructionRenderSystem(DrawingBatch batch) {
        super(2);
        this.batch = batch;
    }
    ...
    public void addedToEngine(Engine engine) {
        entities = engine.getEntitiesFor(Family.all(VisualComponent.class, SizeComponent.class, PositionComponent.class, InContructionComponent.class)
                                                 .get());
    }
