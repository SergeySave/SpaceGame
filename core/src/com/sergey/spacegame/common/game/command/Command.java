...
public final class Command {
    ...
    public boolean equals(Object obj) {
        ...
        return executable.equals(other.executable) && requiresInput == other.requiresInput &&
               requiresTwoInput == other.requiresTwoInput && name.equals(other.name) &&
               drawableName.equals(other.drawableName) && (drawableCheckedName == null ?
                                                                   other.drawableCheckedName == null :
                                                                   drawableCheckedName.equals(other.drawableCheckedName));
    }
    
    @Override
    public int hashCode() {
        return executable.hashCode() <<
               2 + (requiresInput ? 2 : 0) + (requiresTwoInput ? 1 : 0) + name.hashCode() + drawableName.hashCode() +
               (drawableCheckedName == null ? 0 : drawableCheckedName.hashCode());
    }
    
    public static class Adapter implements JsonSerializer<Command>, JsonDeserializer<Command> {
        
        @Override
        public Command deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws
                JsonParseException {
